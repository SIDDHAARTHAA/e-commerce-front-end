  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <div className="text-xs mt-2 text-[#729fcf] font-bold">
          TAGS: [{product.tags}]
        </div>
      </div>
      ...
      <div className="flex items-center justify-center">
        <button
          onClick={addToCart}
          className="px-4 py-2 bg-[#eaeaea] text-black font-bold border-b-4 border-r-4 border-[#111] hover:bg-[#fff] active:border-b-0 active:border-r-0 active:translate-x-[4px] active:translate-y-[4px] transition-all"
        >
          ADD +
        </button>
      </div>
